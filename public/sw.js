// Service Worker for ARC RPG PWA
const CACHE_NAME = 'arc-rpg-v1';
const urlsToCache = [
  '/',
  '/dashboard',
  '/login',
...
// Background sync for quest completion (if supported)
...
async function syncQuests() {
  // This would sync any pending quest completions
...
self.addEventListener('push', (event) => {
  ...
  const title = data.title || 'ARC RPG';
  const options = {
