      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="order-1 lg:order-2 relative bg-gradient-to-br from-yellow-900/20 to-orange-900/20 border-2 border-yellow-500/50 rounded-lg p-6 shadow-[0_0_30px_rgba(234,179,8,0.2)]">
          ...
          <div className="mb-6">
            ...
            <div className="text-4xl font-bold text-white mb-2">$5<span className="text-lg text-gray-400">/mo</span></div>
            <p className="text-sm text-gray-300">or $29/yr — cancel anytime</p>
          </div>
