    ...
    <div className="kidquest min-h-screen bg-cream text-navy">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <Link
            href="/"
            className="text-coral hover:text-hero-blue transition-colors mb-4 inline-block font-semibold"
          >
            ← Back to Home
          </Link>
          <h1 className="kq-display text-4xl font-bold mb-2 text-navy">Terms of Service</h1>
          <p className="text-navy/60">Last updated: November 18, 2025</p>
        </div>

        {/* Content */}
        <div className="kq-card p-6 sm:p-10 prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Agreement to Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Description of Service</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Acceptable Use</h2>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">You May:</h3>
            <ul className="list-disc list-inside text-navy/70 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">You May Not:</h3>
            <ul className="list-disc list-inside text-navy/70 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Premium Subscription</h2>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Pricing</h3>
            <p className="text-navy/70 mb-4">
              HabitQuest offers premium subscriptions starting at $5 USD per month or $29 USD per year. These are recurring payments
              managed through Stripe.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Premium Features</h3>
            <p className="text-navy/70 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Payment Processing</h3>
            <p className="text-navy/70 mb-4">
              Payments are processed securely through Stripe. We do not store your full credit card information.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Refund Policy</h3>
            <p className="text-navy/70 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Price Changes</h3>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">AI-Generated Content</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Intellectual Property</h2>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Our Content</h3>
            <p className="text-navy/70 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Your Content</h3>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Data Privacy</h2>
            <p className="text-navy/70 mb-4">
              Your use of the Service is also governed by our Privacy Policy. Please review it at{' '}
              <Link href="/privacy" className="text-coral hover:underline font-semibold">Privacy Policy</Link>.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Service Availability</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Termination</h2>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">By You</h3>
            <p className="text-navy/70 mb-4">
              You may delete your account at any time through your account settings or by contacting support.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">By Us</h3>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Disclaimers and Limitations</h2>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">No Warranties</h3>
            <p className="text-navy/70 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Limitation of Liability</h3>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Indemnification</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Governing Law and Disputes</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Changes to Terms</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Severability</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-navy">Entire Agreement</h2>
            <p className="text-navy/70 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-none text-navy/70 mb-4 space-y-2">
        ...
        {/* Footer */}
        <div className="mt-12 pt-8 border-t border-stone text-center text-navy/60">
          <p>
            <Link href="/privacy" className="text-coral hover:underline font-semibold mr-4">Privacy Policy</Link>
            <Link href="/" className="text-coral hover:underline font-semibold">Back to Home</Link>
          </p>
        </div>
      </div>
    </div>
