    ...
    <div className="kidquest min-h-screen bg-cream text-navy">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="kq-display text-4xl font-bold mb-2 text-navy">Privacy Policy</h1>
          <p className="text-navy/60">Last updated: November 18, 2025</p>
        </div>

        {/* Content */}
        <div className="kq-card p-6 sm:p-8 prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Information We Collect</h2>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Personal Information</h3>
            <p className="text-navy/80 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Quest and Activity Data</h3>
            <p className="text-navy/80 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Payment Information</h3>
            <p className="text-navy/80 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Automatically Collected Information</h3>
            <ul className="list-disc list-inside text-navy/80 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">How We Use Your Information</h2>
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">AI Processing with Anthropic Claude</h2>
            <p className="text-navy/80 mb-4">
            ...
            <p className="text-navy/80 mb-4">
              Learn more: <a href="https://www.anthropic.com/privacy" target="_blank" rel="noopener noreferrer" className="text-coral hover:underline">Anthropic Privacy Policy</a>
            </p>
          </section>

          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Data Storage and Security</h2>
            <p className="text-navy/80 mb-4">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Data Sharing and Third Parties</h2>
            <p className="text-navy/80 mb-4">
              We do not sell your personal information. We share data only with:
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Service Providers</h3>
            <ul className="list-disc list-inside text-navy/80 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Legal Requirements</h3>
            <p className="text-navy/80 mb-4">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Your Rights and Choices</h2>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Access and Export</h3>
            <p className="text-navy/80 mb-4">
              You can access and export all your data through your account dashboard.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Correction and Deletion</h3>
            <p className="text-navy/80 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">Opt-Out</h3>
            <p className="text-navy/80 mb-4">
              You can opt out of:
            </p>
            <ul className="list-disc list-inside text-navy/80 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-navy">GDPR Rights (EU Users)</h3>
            <p className="text-navy/80 mb-4">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Cookies and Tracking</h2>
            <p className="text-navy/80 mb-4">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">First-Party Analytics</h2>
            <p className="text-navy/80 mb-4">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Data Retention</h2>
            <p className="text-navy/80 mb-4">
              We retain your data:
            </p>
            <ul className="list-disc list-inside text-navy/80 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">International Data Transfers</h2>
            <p className="text-navy/80 mb-4">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Changes to This Policy</h2>
            <p className="text-navy/80 mb-4">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Contact Us</h2>
            <p className="text-navy/80 mb-4">
              For privacy-related questions, concerns, or requests, contact us:
            </p>
            <ul className="list-none text-navy/80 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="kq-display text-2xl font-bold mb-4 text-navy">Jurisdiction</h2>
            <p className="text-navy/80 mb-4">
        ...
        <div className="mt-12 pt-8 border-t border-stone text-center text-navy/60">
          <p>
            ...
            <Link href="/" className="text-coral hover:underline">Back to Home</Link>
          </p>
        </div>
      </div>
    </div>
