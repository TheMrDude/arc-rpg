...
export const COMPANION_SPECIES = {
  ...
  builder: {
    species: 'Ironshell',
    lore: 'Carries its whole home on its back, and builds anyway.',
    stages: [
      { emoji: '🥚', title: 'Stone Egg', name: 'A Stone Egg' },
      { emoji: '🐌', title: 'Pebble Snail', name: 'Pebble Snail', image: '/images/companions/builder/1.png' },
      { emoji: '🐢', title: 'Ironshell', name: 'Ironshell', image: '/images/companions/builder/2.png' },
  ...
  seeker: {
    ...
    stages: [
      // Stage 0 stays emoji: no egg art yet.
