...
export const OVERLAY_REGISTRY = [
  ...
  { id: 'companion-naming', file: 'app/components/CompanionNamingPrompt.js', priority: OVERLAY_PRIORITY.BLOCKING, migrated: false },
  ...
  { id: 'milestone-celebration', file: 'app/components/animations/MilestoneCelebration.js', priority: OVERLAY_PRIORITY.REWARD, migrated: false },
  { id: 'first-quest-celebration', file: 'app/components/FirstQuestCelebration.tsx', priority: OVERLAY_PRIORITY.REWARD, migrated: false },
  { id: 'dice-roll', file: 'app/components/DiceRoll.js', priority: OVERLAY_PRIORITY.REWARD, migrated: false },
  ...
  { id: 'event-story', file: 'app/components/EventStoryModal.js', priority: OVERLAY_PRIORITY.NARRATIVE, migrated: false },
  ...
  { id: 'reflection-prompt', file: 'app/components/ReflectionPrompt.js', priority: OVERLAY_PRIORITY.NARRATIVE, migrated: false },
...
/** Approved for deletion in phase 2. Present so the test does not demand them. */
export const SLATED_FOR_REMOVAL = [
  'app/components/ExitIntentPopup.tsx',
  'app/components/PWAInstallPrompt.js',
  'app/components/animations/MilestoneCelebration.js.bak',
  'app/components/ReflectionPrompt.js.bak',
];
