export const WORLD_REGIONS = [
  ...
  },
  {
    ...
    unlockCondition: 'Stay active 7 days in a row on a physical habit',
    unlockKey: 'streak_7',
  ...
  },
  {
    ...
    unlockCondition: '10 total habit check-ins',
  ...
  },
  {
    ...
    unlockCondition: 'Stay active 14 days in a row on any habit',
    unlockKey: 'streak_14',
  ...
  },
  {
    ...
    unlockCondition: '21 total habit check-ins',
...
export function getUnlockProgress(region, playerData) {
  ...
  switch (unlockKey) {
    case 'streak_7':    return { current: Math.min(longestStreak, 7),   required: 7,  label: 'days in a row' };
    case 'checkins_10': return { current: Math.min(totalCheckins, 10),  required: 10, label: 'check-ins' };
    case 'streak_14':   return { current: Math.min(longestStreak, 14),  required: 14, label: 'days in a row' };
    case 'checkins_21': return { current: Math.min(totalCheckins, 21),  required: 21, label: 'check-ins' };
